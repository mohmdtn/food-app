  ...
  return (
    ...
    <section className={`${logout.sub === "change" ? "d-flex" : "d-none"} justify-content-between flex-grow-1 flex-column align-items-center`}>
      ...
      <section className="row m-0 w-100">
        <div className="col-6 p-0 ps-1"><button className="button1" onClick={() => showLogout("change", "change-number")}>بله <img className="me-2" src={logoutIcon} alt="" /></button></div>
    ...
    <section className={`${logout.sub === "change-number" ? "d-flex" : "d-none"} justify-content-between flex-grow-1 flex-column align-items-center`}>
      ...
      <section className="row m-0 w-100">
        <div className="col-6 p-0 ps-1"><button className="button1" onClick={() => showLogout("change", "change-code")}>تایید</button></div>
        <div className="col-6 p-0 pe-1"><button className="button2" onClick={() => showLogout("change", "change")}>انصراف</button></div>
      </section>
    </section>
